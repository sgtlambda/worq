...
var Worqer = function (processor, options) {
    ...
    this._fn = {
        process: typeof processor !== typeof undefined ? processor : function (threadNo, data) {
            return Q(data);
        },
...
Worqer.prototype._runThread = function (thread) {
    ...
    var args = [threadNo].concat(job.getData());
    var jobResult = Q(this._fn.process.apply(this, args));
...
Worqer.prototype.process = function () {
    ...
    var job = new Job([].splice.call(arguments, 0));
